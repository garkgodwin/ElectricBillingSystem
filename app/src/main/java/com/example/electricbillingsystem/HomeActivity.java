    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardElectricity.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                int count = databaseHelper.countElectricityData();
                    if (count <= 0) {
                        Toast.makeText(HomeActivity.this, "You have no electricity data.", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        cardQuickView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = databaseHelper.countElectricityData();
                if(count <= 0){
                    Toast.makeText(HomeActivity.this, "You have nothing to view.", Toast.LENGTH_SHORT).show();
                }
                else {
